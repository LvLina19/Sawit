...
class LaporanFragment : Fragment() {
    ...
    private fun setupClickListeners() {
        // Tombol Back di Toolbar - Navigate to BerandaFragment
        btnBack.setOnClickListener {
            Log.d(TAG, "Back button clicked - navigating to Beranda")
            navigateToBeranda()
        }
